...
export const STUDENT_URL = `${BACKEND_ROOT}/student`;
export const TEACHER_SIGNUP_URL = `${BACKEND_ROOT}/teacher`;
...
export const LOGGED_IN_USER_INFO = `${BACKEND_ROOT}/auth/me`;
export const JOB_APPLICATION_URL = `${BACKEND_ROOT}/job-applications`;
export const COMPANY_EVALUATION_STATUS_URL = `${BACKEND_ROOT}/company-evaluation-status`;
